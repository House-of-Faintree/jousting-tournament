...
\textit{	Now, for each module, give the outline of how it will work. In this section it is appropriate to present \\
	...
	\begin{itemize}
		...
		\item menu\textunderscore ref\textunderscore 2 - Integer that determines submenu and submenu variable to be operated on (0-7)
	\end{itemize}

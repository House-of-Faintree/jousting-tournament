 ...
 *
 * EDITED 15 OCTOBER 2015
 *   -   This file now contains everything necessary for communication both to and
 *      from the two PICs. The recieve interrupt is included in this file.
 *      any file calling functions from here also have access to the GLOBAL variable
...
void setupSerial(void){
  ...
  TXSTAbits.TXEN = 1;
  //BAUDCONbits.BRG16 = 0;        //ONLY ON MNML BOARD
  SPBRG = 25;

  //SPBRG = 16;                     //Set baudrate to 9600 for MNML board
